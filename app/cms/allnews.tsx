...
export default function AllNews() {
 useEffect(()=> {
  publicIP()
    .then(ip => {
        fetch(`${SERVER}` + '/api/session/cms/allnews/?ip=' +ip, {
            "method": 'GET',
            "credentials": 'include'
        })
      ...
      <div className="container" id="main">
        <div className="tab-area">
          <div className="row">
            ...
            <div id="contentSection" className="col-md-9 float-right border-secondary border-radius-8 p-0 d-inline-block d-xs-block mr-1" id="CmsContent">
