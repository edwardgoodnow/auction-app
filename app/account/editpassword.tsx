...
export default function Account() {
 useEffect(()=> {
  publicIP()
    .then(ip => {
        fetch(`${SERVER}` + '/api/session/account/register/?ip=' +ip, {
            "method": 'GET',
            "credentials": 'include'
        })
  ...
  return (
    <>
     <Header />
     <SearchForm />
      <div className="container no_auctions" id="main">
        <div className="tab-area">
            <div className="col-md-2 d-inline-block d-xs-none float-left"></div>
            <div className="col-md-9 float-right border-secondary border-radius-8 p-0 d-inline-block d-xs-block mr-1">
